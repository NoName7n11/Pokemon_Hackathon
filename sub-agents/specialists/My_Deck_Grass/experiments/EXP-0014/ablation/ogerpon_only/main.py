...
def _promotion_adjust(mon, state, opp_active) -> int:
    """Ablation: keep Ogerpon ex Benched (Tera immunity), only when an alternative attacks."""
    if mon is None or state is None or mon.id != 96:
        return 0
    ...
    return -200 if alternative else 0
