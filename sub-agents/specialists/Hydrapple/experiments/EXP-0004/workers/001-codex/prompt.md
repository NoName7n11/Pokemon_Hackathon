...
When choosing a normal Energy attachment, prefer an in-play Pokemon when that single attachment makes one of its attacks usable this turn; preserve Active preference and existing strength ordering as tie-breakers.

Expected effect:
Reduce wasted attachments that leave all attackers unusable without broadly switching to bench-first attachment.

Mechanism under test:
attack_readiness_attachment
