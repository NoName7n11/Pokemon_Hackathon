...
FROZEN 2026-08-08: this is main.py as of the "cleaned promotion-scoring" agent --
MAIN-phase 1-ply lookahead + live-attacker ranking for own-board CARD selection
(forced promotion after a KO), with the ablated-to-zero tactical retreat gate removed.

It replaces the 2026-07-18 pre-lookahead greedy policy, which had become too stale to
measure against: every change since scored 60-72% against it, so it no longer
discriminated between good and mediocre work. Reference points for this policy, vs
that old baseline: self-play 71.6% [67.5-75.4] n=500, 97.0% vs random n=200.

Keep this file stable. Do not edit it to track main.py -- re-freeze deliberately, and
log the re-freeze in PROGRESS.md when you do.
"""
